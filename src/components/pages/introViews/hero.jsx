...
const Heropage = () => {
    return (
        <>
            <div className="relative z-10 h-screen overflow-y-auto lg:overflow-hidden">
                ...
                <div className="relative bg-emerald-700 bg-opacity-90 h-full">
                    ...
                    <div className="relative mx-auto overflow-hidden h-full my-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
                        <div className="flex flex-col items-center h-full justify-between md:flex-row my-auto">
                            <div className="mb-12 w-full max-w-xl xl:mb-0 xl:w-7/12 xl:pr-16">
                                <h2 className="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-white sm:text-7xl sm:leading-none">Online Exams Made Easy</h2>
                                <p className="mb-4 max-w-xl text-base text-gray-200 md:text-lg">Simplify the way students take exams and teachers manage them with our intuitive online exam system.</p>
