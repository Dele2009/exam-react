    ...
    <>
      <div ref={containerRef} className="h-dvh overflow-y-scroll mb-20">
        <motion.header
          ...
          className="backdrop-blur-lg lg:backdrop-blur-none rounded-b-3xl shadow-2xl text-slate-700 absolute overflow-hidden lg:overflow-visible top-0 lg:-top-5 w-full z-50 mx-auto flex flex-col  px-0 md:px-8 lg:flex-row lg:items-center lg:justify-center"
        >
          <Link
            to="/"
          ...
          <nav
            ...
            className="backdrop-blur-lg md:backdrop-blur-none lg:peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col lg:ml-auto items-center overflow-hidden lg:overflow-visible  transition-all lg:max-h-full lg:flex-row lg:items-center"
          >
            <ul className="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0  lg:h-full lg:pt-8 lg:pb-4">
            ...
            <div className="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0  lg:pt-8 lg:pb-4">
              {!user ? (
                <Link
                  to="/login"
                  style={fontVarient}
