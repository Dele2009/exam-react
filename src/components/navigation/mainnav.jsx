...
const Navbar = () => {
    ...
    useEffect(() => {
        if (scrollY > 0) {
            controls.start({ backgroundColor: "#ffffff",color: 'black', boxShadow: '0px 0px 15px gray' });
        } else {
            controls.start({ backgroundColor: "transparent",color: 'white' , boxShadow: 'none' });
        }
        console.log(scrollY)
    }, [scrollY, controls]);
    ...
    return (
        <>
            <div ref={containerRef} className="h-dvh overflow-y-scroll mb-20">
                <motion.header
                    animate={controls}
                    initial={{ backgroundColor: "transparent",color: 'white' , boxShadow: 'none' }}
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                            <div className="sm:col-span-2">
                                ...
                                <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                                    <input id="email" type="text" className="px-4 py-2 text-gray-700 bg-white border rounded-md focus:border-emerald-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-emerald-300" placeholder="Email Address" />
                            ...
                            <div>
                                ...
                                <div className="flex flex-col items-start mt-5 space-y-2">
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Home</p>
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Who We Are</p>
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Our Philosophy</p>
                                </div>
                            </div>
                            <div>
                                <p className="font-semibold text-white">Industries</p>
                                <div className="flex flex-col items-start mt-5 space-y-2">
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Retail & E-Commerce</p>
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Information Technology</p>
                                    <p className="text-gray-200 transition-colors duration-300 hover:underline hover:cursor-pointer hover:text-gray-400">Finance & Insurance</p>
                                </div>
                            </div>
                        </div>
                        <p className="font-sans p-8 text-start md:text-center md:text-lg text-white">© 2023 Your Company Inc. All rights reserved.</p>
                    </div>
                </footer>
                <LogoutModal/>
            </div>
