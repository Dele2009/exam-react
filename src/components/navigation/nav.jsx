...
const Navbar = ({ children }) => {
    ...
    return (
        <>
            ...
            <header className="backdrop-blur-lg md:backdrop-blur-none text-slate-700 absolute top-0 w-full z-50 mx-auto flex flex-col overflow-hidden px-0  md:px-4 py-5 lg:flex-row lg:items-center">
                ...
                <nav aria-label="Header Navigation" className="backdrop-blur-lg md:backdrop-blur-none peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col lg:ml-auto items-center overflow-hidden transition-all lg:ml-24 lg:max-h-full lg:flex-row">
