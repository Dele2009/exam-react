                                ...
                                {isAddUserCollapsed && (
                                    <ul className="rounded-md mt-2 text-sm  space-y-2 w-full bg-slate-800 p-4">
                                        <li className='px-2 py-2 flex items-center justify-start  text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md'>
                                            ...
                                            <Link to='users' className=" block  ml-2">All users</Link>
                                        </li>
                                        <li className='px-2 py-2 flex items-center justify-start  text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md'>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                        ...
                        <li className="relative">
                            ...
                            {isAddUserCollapsed2 && (
                                <ul className="rounded-md mt-2 text-sm  space-y-2 w-full bg-slate-800 p-4">
                                    ...
                                    <li>
                                        <Link to='newuser/teacher' className=" block px-4 py-2 text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md">Update Exam</Link>
                                    </li>
                                </ul>
                            )}
                        </li>
