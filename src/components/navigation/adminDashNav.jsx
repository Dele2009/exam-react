    ...
    return (
        <div className="bg-slate-200 dark:bg-gray-700 flex h-screen overflow-hidden">
            <aside className="fixed z-50 md:relative">
                ...
                <label
                    className="peer-checked:rounded-full peer-checked:p-2 peer-checked:right-6 peer-checked:top-9 peer-checked:bg-gray-600 peer-checked:text-white absolute top-8 z-20 mx-4 cursor-pointer"
                ...
                <nav aria-label="Sidebar Navigation"
                    ...
                    <div className="bg-slate-800 mt-5 py-2 pl-3 md:mt-1">
                        {/* <Link to="/" className="">
                            <span
                        ...
                        <Link to="/Dashboard" className="text-xl font-bold flex items-center">
                            {/* <FaUsers /> */}
                            <Logo className="w-6/12 h-7 sm:h-24" />
                            </Link>
                    </div>
                    <ul className="mt-8 md:mt-20 px-4 space-y-3 overflow-y-auto overflow-x-hidden">
                        ...
                        {user && user.role === 'Admin' && (
                            <li className="relative">
                                ...
                                <motion.ul
                                    ...
                                    animate={{ height: isUsersCollapsed ? 'auto' : 0, opacity: isUsersCollapsed ? 1 : 0 }}
                                    transition={{ duration: 0.3 }}
                                    className={`overflow-hidden rounded-md mt-2 text-sm space-y-2 w-full bg-slate-800 p-4 ${isUsersCollapsed ? '' : 'hidden'}`}
                                >
                                    ...
                                    <li className='text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md'>
                                        <Link to='newuser/admin' className="flex gap-2 items-center justify-start px-4 py-2 ml-2">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 4.5c0 .621-.504 1.125-1.125 1.125S7.5 5.121 7.5 4.5 8.004 3.375 8.625 3.375 9.75 3.879 9.75 4.5ZM21 20.25a11.25 11.25 0 0 1-21 0v-1.5c0-1.35.78-2.55 1.986-3.165a1.874 1.874 0 0 1 2.516.788 7.456 7.456 0 0 0 12.997 0 1.875 1.875 0 0 1 2.516-.788A3.75 3.75 0 0 1 21 18.75v1.5Zm-.75-15.75a2.25 2.25 0 1 0-4.5 0 2.25 2.25 0 1 0 4.5 0Zm-9-4.5A2.25 2.25 0 1 1 9 1.5a2.25 2.25 0 0 1 1.25 1.125Zm-6 2.25a2.25 2.25 0 1 0 4.5 0 2.25 2.25 0 1 0-4.5 0Z" />
                                                </svg>
                                            </span>
                        ...
                        {user && user.role === 'Admin' && (
                            <li className="relative">
                                ...
                                <motion.ul
                                    initial={{ height: 0, opacity: 0 }}
                                    animate={{ height: isExamsCollapsed ? 'auto' : 0, opacity: isExamsCollapsed ? 1 : 0 }}
                                    transition={{ duration: 0.3 }}
                                    className={`overflow-hidden rounded-md mt-2 text-sm space-y-2 w-full bg-slate-800 p-4 ${isExamsCollapsed ? '' : 'hidden'}`}
                                >
                                    <li className='text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md'>
                                        <Link to='allExams' className="flex gap-2 items-center justify-start px-4 py-2 ml-2">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 6.75V4.5A2.25 2.25 0 0 0 16.5 2.25H7.5A2.25 2.25 0 0 0 5.25 4.5v2.25m13.5 0h-13.5m13.5 0a2.25 2.25 0 0 0 2.25 2.25v9a2.25 2.25 0 0 0-2.25 2.25h-13.5A2.25 2.25 0 0 0 3 18v-9a2.25 2.25 0 0 0 2.25-2.25m-.75 0h13.5" />
                                                </svg>
                                            </span>
                                    ...
                                    <li className='text-gray-300 hover:bg-slate-600 focus:bg-slate-600 rounded-md'>
                                        <Link to='createExam' className="flex gap-2 items-center justify-start px-4 py-2 ml-2">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5h-9m4.5-4.5v9m9 6.75v-4.5a1.5 1.5 0 0 0-1.5-1.5h-6a1.5 1.5 0 0 0-1.5 1.5v4.5m9 0H5.25m13.5 0h-4.5m-4.5 0h-4.5m13.5 0v-2.25a1.5 1.5 0 0 0-1.5-1.5h-6a1.5 1.5 0 0 0-1.5 1.5v2.25" />
                                                </svg>
                                            </span>
