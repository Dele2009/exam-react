            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 z-50 w-56 py-2 mt-2 overflow-hidden origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800"
                    >
                        {menuItems.map((item, index) => (
                            <Link
                                ...
                                className={`flex items-center p-3 text-sm text-gray-600 transition-colors duration-300 transform dark:text-white bg-${item.color ? item.color : ''}-700 hover:bg-${item.color || 'gray'}-100`}
                            >
                                {item.icon && (
                                    <span className="mr-2">
