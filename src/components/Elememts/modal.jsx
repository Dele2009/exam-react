...
const Modal = ({ 
    ...
    return (
        <>
            {isOpen && (
                <motion.div
                    className="fixed inset-0 z-50 flex items-center justify-center px-12 overflow-x-hidden overflow-y-auto bg-black bg-opacity-60"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-5 border-b border-solid rounded-t border-blueGray-200">
                            ...
                            <button
                                className="p-1 ml-auto bg-transparent border-0 text-black  rounded-full hover:bg-gray-200 focus:outline-none"
                                onClick={onCancel}
                            >
